...
<script>
  import {getPhoneCode,pwdLogin,phoneCodeLogin} from "./../../api/index";
  ...
  import {mapActions} from "vuex"
    export default {
      ...
      data(){
          return{
            loginMode:true,//登录方式，ture:验证码登录；false:密码登录
            phone:"",//手机号码
            countDown:0,//倒计时
